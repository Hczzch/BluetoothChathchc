        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ChatConstant.MESSAGE_TOAST:
                    ...
                    break;
                case ChatConstant.CONNECTED:{
                    if(mChatCallback != null){
                        mChatCallback.showConnected();
                    }
                }
            }
        }
...
//        mHandler.obtainMessage(ChatConstant.MESSAGE_TOAST,)
        return this;
    }
    ...
    public synchronized void connected(BluetoothSocket socket,
        ...
        mHandler.obtainMessage(ChatConstant.CONNECTED, -1 , -1, "Connected").sendToTarget();        //?????
